...
public class Lab7Test {
	...
	public void problems4Through5() throws IOException {
		// names1.txt:
		NameSorter ns = new NameSorter("src/names1.txt");
		ns.sortNames();
		;
		...
		assertEquals(linesList, java.nio.file.Files.readAllLines(new File("src/names1.txt").toPath()));

		// names1.txt:
		ns = new NameSorter("src/names2.txt");
		ns.sortNames();
		;
		...
		assertEquals(linesList, java.nio.file.Files.readAllLines(new File("src/names2.txt").toPath()));
	}
	...
	public void problem6() {
		// test1.txt:
		WordCounter wc1 = new WordCounter("src/test1.txt");
		...
		// test2.txt:
		WordCounter wc2 = new WordCounter("src/test2.txt");
		...
		// text3.txt:
		WordCounter wc3 = new WordCounter("src/test3.txt");
