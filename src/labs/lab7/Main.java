...
public class Main {
	...
	public static int problem3_count8s(int n) {
		...
		if (numDigits==0) {
			...
			if (num.charAt(0)=='8' && num.charAt(1)=='8'){
				return 2+problem3_count8s(Integer.valueOf(num.substring(1)));
			}else if (num.charAt(0)=='8' && num.charAt(1)!='8') {
				return 1+problem3_count8s(Integer.valueOf(num.substring(1)));
			}else {
				return problem3_count8s(Integer.valueOf(num.substring(1)));
			}
		}
