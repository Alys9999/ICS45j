...
public class Lab6Test {
	...
	public void problems1And2() throws IOException {
		TextImprover ti = new TextImprover("./src/overused-words.txt");
		
		// overused1.txt:
		String testFileName = "src/overused1.txt";
		...
		// overused2.txt:
		testFileName = "src/overused2.txt";
		ti.improveText(testFileName);
...
//		assertIterableEquals(expClasses, george.getClasses());
	...
	public void problem4() throws IOException {
		String prodFileName = "src/products.txt";
